...
function Form({handleAddCommentClick}) {
  // formRef, 
    return (
        <>
        ...
        <div className="form-section__container">
          ...
          <div className="form-section__content">
            ...
            <form className="form-section__form" onSubmit={(event) => event.preventDefault()}>
            {/* ref={formRef}  */}
              <textarea type="text" name="comment" className="form-section__input" id="comment" placeholder=" Add a new comment"></textarea>
              <button className="form-section__comment-wrapper" onClick={(event) => handleAddCommentClick()} >
